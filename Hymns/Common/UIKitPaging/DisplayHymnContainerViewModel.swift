...
class PageViewModel: ObservableObject {
    ...
    @Published var arrayHymns = [DisplayHymnView]()
    ...
    init(hymnToDisplay hymnIdentifier: HymnIdentifier, mainQueue: DispatchQueue = Resolver.resolve(name: "main")) {
        ...
        for hymnNumber in 1...hymnIdentifier.hymnType.maxNumber {
            ...
            arrayHymns.append(DisplayHymnView(viewModel: DisplayHymnViewModel(hymnToDisplay: HymnIdentifier(hymnType: hymnIdentifier.hymnType, hymnNumber: "\(hymnNumber)", queryParams: hymnIdentifier.queryParams))))
        }
