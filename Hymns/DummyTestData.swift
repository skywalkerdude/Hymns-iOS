...
let testData = [
    ...
    DummyHymnView(dummyHymn: DummyHymn(songTitle: "Hymn 123", songLyrics: "Low in the grave He lay- Jesus my Savior! Waiting the coming day- Jesus my Lord!")),
    DummyHymnView(dummyHymn: DummyHymn(songTitle: "Hymn 480", songLyrics: "Joined unto Christ the Conqueror")), DummyHymnView(dummyHymn: DummyHymn(songTitle: "Hymn 20", songLyrics: "God our Father we adore thee")), DummyHymnView(dummyHymn: DummyHymn(songTitle: "Hymn 123")), DummyHymnView(dummyHymn: DummyHymn(songTitle: "Hymn 89")), DummyHymnView(dummyHymn: DummyHymn(songTitle: "Hymn 16")), DummyHymnView(dummyHymn: DummyHymn(songTitle: "What about my sinful past")), DummyHymnView(dummyHymn: DummyHymn(songTitle: "Hymn 98")), DummyHymnView(dummyHymn: DummyHymn( hymnNumber: "Hymn 45", songTitle: "Hymn 45"))
]
